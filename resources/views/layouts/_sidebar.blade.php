<aside class="hidden md:flex md:flex-col sidebar bg-[#0f3b33] text-white py-6 gap-4 items-center sticky top-[56px] h-[calc(100vh-56px)]">
  ...
  <a href="{{ url('/pickups') }}" class="w-10 h-10 grid place-content-center rounded-xl hover:bg-white/10" title="Programar">📍</a>
  <a href="{{ url('/u/puntos') }}" class="w-10 h-10 grid place-content-center rounded-xl hover:bg-white/10" title="Puntos">💳</a>

  <a href="{{ url('/profile') }}" class="mt-auto w-10 h-10 grid place-content-center rounded-xl hover:bg-white/10" title="Configuración">⚙️</a>
</aside>
